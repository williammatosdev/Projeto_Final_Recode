...
namespace CadastroElogin.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_usuario,Nome,Sobrenome,Email,Sexo,Senha")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
                _context.Add(usuario);
                await _context.SaveChangesAsync();
               // return Json(new{msg = "Usuario cadastrado com sucesso!" });
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_usuario,Nome,Sobrenome,Email,Sexo,Senha")] Usuario usuario)
        {
